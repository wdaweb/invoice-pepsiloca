...
?>
    ...
    ?>
            <tr class="tt">
                ...
                <td><?=$row['expend']."元";?></td>
                <td>
                    <a href="edit_invoice.php?id=<?=$row['id'];?>&period=<?=$p;?>" role="button"><button class="btn btn-primary btn-sm">編輯</button></a>

                    <a href="del_invoice.php?id=<?=$row['id'];?>&period=<?=$p;?>" role="button"><button class="btn btn-primary btn-sm">刪除</button></a>
                </td>
            </tr>
            <?php
    }
